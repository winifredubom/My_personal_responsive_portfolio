  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'REST APIs',image: 'assets/icons/api.png'),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Kotlin',image: 'assets/icons/kotlin.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.4, title: 'Provider',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.93, title: 'Getx',image: 'assets/icons/dart.png'),
         AnimatedLinearProgressIndicator(percentage: 0.60, title: 'Riverpod',image: 'assets/icons/dart.png'),
      ],);
  }
}
